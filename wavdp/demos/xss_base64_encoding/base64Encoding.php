	<div id='wrappper'>			
		<h4 class="text-primary">Base-64 Encoding based XSS attack</h4><br> 		
		<div>
			<table  style="width:100%; height:auto; padding:10px;" align="center">
				<tr>
					<td>																	
						...
						if( isset($_GET['inp1']) || isset($_POST['inp1']) )
						{
                            ...
                            <?php
							include_once("base64Encoding_submit.php");
							?>
							</div>
							<hr> 
							<?php
						...
						<form method="post" action="" >					
							Enter Name: <input type="text" name="inp1" /> 	
							&nbsp;&nbsp;&nbsp;&nbsp;
							Security Level: 
				...
				<tr>					
					<td align="right">
						...
						<?php
						$path = "demos/xss_base64_encoding/base64Encoding_submit.php"; ### Path of the source code file
						...
						<br><br>				
						<a href=".?page=demos/help.php#2_e_2" target="_blank">Help</a>	
					</td>
				</tr>
			</table>				
