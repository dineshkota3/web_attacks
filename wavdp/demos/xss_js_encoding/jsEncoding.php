	<div id='wrappper'>			
		<h4 class="text-primary">JS Encoding based XSS attack</h4><br> 		
		<div>
			<table  style="width:100%; height:auto; padding:10px;" align="center">
				<tr>
					<td>																	
						...
						if( isset($_GET['inp1']) || isset($_POST['inp1']) )
						{
                            ...
                            <?php
							include_once("jsEncoding_submit.php");
							?>
							</div>
							<hr> 
							<?php
				...
				<tr>					
					<td align="right">
						...
						<?php
						$path = "demos/xss_js_encoding/jsEncoding_submit.php"; ### Path of the source code file
						...
						<br><br>				
						<a href=".?page=demos/help.php#2_e_3" target="_blank">Help</a>							
					</td>
				</tr>
			</table>				
