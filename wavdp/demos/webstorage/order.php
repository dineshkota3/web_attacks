...
<body style="background: #BABABB">
	...
	<header class="header-10" style="height: 120px;">
			<div class="container">
				<div class="navbar col-sm-12" role="navigation">
					...
					<div><a style="float: right;margin-top: 80px; color : #FFFFFF;font-size: 22px;"  href="index.php" onclick="localStorage.clear();">
						Home</a></div>
				</div>
			</div>
	</header>
	...
	document.write("	<button class='btn item' type='submit'  name='mobile' ><span class='span_left'>" + i + "</span><span class='span_right'>"+ localStorage.getItem(i)+"	</span>  	</button> ");
