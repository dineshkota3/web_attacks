	<div>			
		<h4 class="text-primary">HTML Injection</h4><br>	
			...
			<table  style="width:100%; height:auto; padding:10px;" align="center">
				<tr>
					<td>	                        
						...
						if( isset($_GET['inp1']) || isset($_POST['inp1']) )
						{
                            ...
                            <?php
                            include_once("htmlInj_submit.php");
                            ?>
                            </div>
                            <hr>                            
                            <?php
				...
				<tr>					
					<td align="right">
						...
						<?php
						$path = "demos/html_injection/htmlInj_submit.php"; ### Path of the source code file
						...
						<br><br>				
						<a href=".?page=demos/help.php#1" target="_blank">Help</a>
					</td>
				</tr>
			</table> 			
		</div>	
