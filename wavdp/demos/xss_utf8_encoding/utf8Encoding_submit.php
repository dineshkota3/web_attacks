<h5 class="text-danger" align="center">UTF-8 Encoding based XSS Attack!</h5>	
...
if( isset($_GET['inp1']) || isset($_POST['inp1']) )
{
	...
	{	
		...
		?>
		<div align="center">					
			<p id="utf8tempout"><?php echo $inputData; ?></p>
			<iframe name="<?php echo $inputData; ?>" onload="eval(name);"; > 			
		</div>			
	<br>
	<?php
}
