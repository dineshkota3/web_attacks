	<div id='wrappper'>			
		<h4 class="text-primary">SQL Injection</h4><br>	
			...
			<table  style="width:100%; height:auto; padding:10px;" align="center">
				...
				<tr>					
					<td align="right">
						...
						<?php
						$path = "demos/sql_injection/sqli1_submit.php"; ### Path of the source code file
						...
						<br><br>				
						<a href=".?page=demos/help.php#4" target="_blank">Help</a>											
					</td>
				</tr>
			</table> 			
		</div>	
