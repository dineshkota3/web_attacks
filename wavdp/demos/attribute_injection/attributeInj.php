	<div id='wrappper'>					
		<h4 class="text-primary">Attribute Injection</h4><br>
		<div>
			<table  style="width:100%; height:auto; padding:10px;" align="center"> 
				<tr>
					<td>
						...
						if( isset($_GET['inp1']) || isset($_POST['inp1']) )
						{
                            ...
                            <?php
							include_once("attributeInj_submit.php"); 	
							?>
							</div>
							<hr> 
							<?php
						...
						<form method="post" action="" >
							Enter Height: <input type="text" name="inp1" />
							&nbsp;&nbsp;&nbsp;&nbsp;
							Security Level: 
				...
				<tr>					
					<td align="right">
						...
						<?php
						$path = "demos/attribute_injection/attributeInj_submit.php"; ### Path of the source code file
						...
						<br><br>				
						<a href=".?page=demos/help.php#2_d" target="_blank">Help</a>										
					</td>
				</tr>
			</table>				
